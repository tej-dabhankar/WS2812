...
module edb_top (
    ...
    output bscan_TDO,
    input  la0_clk,
    input  [19:0] la0_probe0,
    input  la0_probe1,
    input  [23:0] la0_probe2,
    input  la0_probe3,
    input  la0_probe4,
    input  la0_probe5,
    input  la0_probe6,
    ...
    input  [11:0] la0_probe14,
    input  la0_probe15,
    input  [7:0] la0_probe16,
    input  [19:0] la0_probe17,
    input  [7:0] la0_probe18,
    input  la0_probe19,
    input  [11:0] la0_probe20,
    input  la0_probe21,
    input  [7:0] la0_probe22,
    input  [11:0] la0_probe23,
    input  [3:0] la0_probe24,
    input  [23:0] la0_probe25,
    input  [19:0] la0_probe26,
    input  [19:0] la0_probe27,
    input  la0_probe28,
    input  la0_probe29,
    input  [23:0] la0_probe30,
    input  la0_probe31,
    input  la0_probe32,
    input  [3:0] la0_probe33,
    input  la0_probe34,
    input  [11:0] la0_probe35
);
    ...
    edb_la_top #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 1 ),
        .UUID   ( 128'hb9dcd5dfa82d4ae38c8cad64c6dec720 ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 20 ),
        .PROBE0_TYPE        ( 1 ),
        .PROBE1_WIDTH       ( 1 ),
